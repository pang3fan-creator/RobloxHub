...
export function QuickReference({ items }: QuickReferenceProps) {
  ...
  const colorMap: Record<string, string> = {
    ...
    emerald:
      'text-emerald-400 group-hover:text-emerald-300 hover:border-emerald-500/50',
    amber:
      'text-amber-400 group-hover:text-amber-300 hover:border-amber-500/50',
    orange:
      'text-orange-400 group-hover:text-orange-300 hover:border-orange-500/50',
    purple:
      'text-purple-400 group-hover:text-purple-300 hover:border-purple-500/50',
    ...
    violet:
      'text-violet-400 group-hover:text-violet-300 hover:border-violet-500/50',
  };
