...
const components = {
  h1: ({ children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => {
    ...
    return (
      <h1
        id={id}
        className="text-4xl font-bold text-slate-900 dark:text-white mb-6 scroll-mt-24"
        {...props}
      >
        {children}
      </h1>
  ...
  h2: ({ children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => {
    ...
    return (
      <h2
        id={id}
        className="text-3xl font-bold text-slate-900 dark:text-white mt-12 mb-4 scroll-mt-24"
        {...props}
      >
        {children}
      </h2>
  ...
  h3: ({ children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => {
    ...
    return (
      <h3
        id={id}
        className="text-2xl font-semibold text-slate-900 dark:text-white mt-8 mb-3 scroll-mt-24"
        {...props}
      >
        {children}
      </h3>
