...
export function GameMDX({ source }: GameMDXProps) {
  return (
    <div className="prose prose-invert prose-slate prose-lg max-w-none
                    ...
                    prose-h3:text-2xl prose-h3:mb-4 prose-h3:mt-6 prose-h3:leading-tight prose-h3:font-semibold prose-h3:text-slate-200
                    ...
                    prose-code:text-purple-300 prose-code:bg-slate-800 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:font-mono
