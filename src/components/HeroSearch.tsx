    ...
    <form onSubmit={handleSubmit} className="w-full max-w-xl mx-auto">
      <div
        className={`
          ...
          bg-slate-200/60 dark:bg-slate-800/60 backdrop-blur-md
      ...
      >
        ...
        >
          ...
          <input
            ...
            className="flex-1 bg-transparent text-slate-700 dark:text-slate-500 placeholder-slate-500 dark:placeholder-slate-600 outline-none text-lg cursor-not-allowed"
          />
        </div>
      </div>
      <p className="text-center text-slate-500 dark:text-slate-600 text-sm mt-3">
        搜索功能即将上线
      </p>
    </form>
  );
