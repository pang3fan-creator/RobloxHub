...
## 6. 开发路线图 (24 小时 MVP 冲刺)

- **T+0h - T+6h**：Next.js 环境搭建、i18n 路由配置、Portal 主页基础框架搭建。
- **T+7h - T+14h**：首个 Pillar Content（Scary Shawarma Kiosk 异常清单与全结局）的 MDX 录入与 AnomalySlider 组件开发。
- **T+15h - T+20h**：UI 精修（Dark Mode、悬浮导航、毛玻璃效果、平滑滚动）。
- **T+21h - T+24h**：SEO 结构化数据注入、Vercel 自动化部署、提交 sitemap 至搜索引擎。
